...
>
> $$P(Y_{ni} = 1, Y_{nj} = 1, Y_{nk} = 1| \theta_n) = P(Y_{ni} = 1|\theta_n) \cdot P(Y_{nj} = 1|\theta_n) \cdot P(Y_{nk} = 1|\theta_n)$$
>
...
![The illustration is similar to Figure 2.4 in \@debelak2022](figures_irt_tutorial/spec_obj_ICCs_Rasch.png){#fig_ICC_spec_obj_Rasch}
...
![The illustration is similar to Figure 2.4 in \@debelak2022](figures_irt_tutorial/spec_obj_ICCs_2PL.png){#fig_ICC_spec_obj_2PL}

> It can also be shown mathematically that specific objectivity holds under the Rasch model, as demonstrated, for example, in [@debekla2000, p. 30] and below.
>
